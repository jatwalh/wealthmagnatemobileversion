...
function ViewCombination({ route }) {
    const navigation = useNavigation();

    const [selectedCombination, setSelectedCombination] = useState([]);

    useEffect(() => {
        setSelectedCombination(route.params.selectedStockData);
    }, [route.params]);
                            ...
                            <View style={[commonStyles.widget2, commonStyles.paddingleft1]} >
                                ...
                                <View style={styles.tableRow}>
                                    <View style={styles.tableCell}>
                                        <Text style={commonStyles.textgolden}>Strategy 1:</Text>
                                    </View>
                                    <View style={styles.tableCell}>
                                        <Text style={[commonStyles.textwhite]}>
                                        {selectedCombination.CAtrategyOne ? selectedCombination.CAtrategyOne.strategyName : 'N/A'}
                                        </Text>
                                    </View>
                                </View>
                                ...
                                <View style={styles.tableRow}>
                                    <View style={styles.tableCell}>
                                        <Text style={commonStyles.textgolden}>Strategy 2:</Text>
                                    </View>
                                    <View style={styles.tableCell}>
                                        <Text style={[commonStyles.textwhite]}>
                                        {selectedCombination.CAstrategyTwo ? selectedCombination.CAstrategyTwo.strategyName : 'N/A'}
                                        </Text>
                                    </View>
                                </View>
                                ...
                                <View style={styles.tableRow}>
                                    ...
                                    <View style={styles.tableCell}>
                                        <Text style={[commonStyles.textwhite]}>
                                         {selectedCombination.createdAt && formatDate(selectedCombination.createdAt)}
                                         {' '}
                                         {selectedCombination.createdAt && formatTime(selectedCombination.createdAt)}
                                        </Text>
                                    </View>
                                </View>
                                ...
                                <View style={styles.tableRow}>
                                    <View style={styles.tableCell}>
                                        <Text style={commonStyles.textgolden}>Stocks:</Text>
                                    </View>
                                    <View style={styles.tableCell}>
                                        <Text style={[commonStyles.textwhite]}>
                                        {selectedCombination.CAstockID ? selectedCombination.CAstockID.stockName : 'N/A'}
                                        </Text>
                                    </View>
                                </View>
                                ...
                                <View style={styles.tableRow}>
                                    <View style={styles.tableCell}>
                                        <Text style={commonStyles.textgolden}>Tenure:</Text>
                                    </View>
                                    <View style={styles.tableCell}>
                                        <Text style={[commonStyles.textwhite]}>
                                        {
                                        selectedCombination.timeDuration !== undefined && (
                                            `${selectedCombination.timeDuration} ${selectedCombination.timeDuration === 1 ? 'hour' : 'hours'}`
                                        )
                                        }
                                        </Text>
                                    </View>
